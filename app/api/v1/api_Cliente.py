...
from app.services import ClienteService as cliente_service
from app.schemas.ClienteSchema import ClienteSchema, ConsultAllClientsResponse, ConsultClientResponse, ClienteUpdateSchema
